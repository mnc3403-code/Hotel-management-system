...
const AllRoom = () => {
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify justify-between pt-28 md:pt-35  px-4 md:px-16 lg:px-24 xl:px-32'>
        <div>
           <div className='flex flex-col items-start text-left'>
             <h1 className='font-playfair text-4xl md:text-[40px]'>Hotel Rooms</h1>
             <p className='text-base text-gray-500/90 mt-2 mx-w-174'>Explore our variety of comfortable and well-appointed hotel rooms designed to provide you with a perfect stay .</p>
           </div>

            {roomsDummyData.map((room)=>(
              <div key={room._id} className='flex flex-col md:flex-row items-start justify-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0' >
        ...
        <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 lg:mt-16'>
              ...
              <div className={`${openFilters ? "h-auto" : "h-0 lg:h-auto"} overflow-hidden transition-all duration-700`}>
                <div className='px-5 pt-5'>
                  <p className='font-medium text-gray-800 pb-2'>Top Filters</p>
                  {roomtypes.map((room, index) => (
                    <CheckBox key={index} label={room}/>
                  ))}
                </div>
                <div className='px-5 pt-5'>
                  <p className='font-medium text-gray-800 pb-2'>Select Your Comfort Level</p>
