...
const ListRoom = () => {
  ...
  return (
    <div>
      <Title align="left" font="outfit" title="Room List" subtitle="View ,edit or manage all available rooms. keep the information up to date to provide the best experience for users" />
                      ...
                      <label className='relative inline-flex items-center cursor-pointer'>
                        <input 
                          ...
                          onChange={() => {
                            ...
                            newRooms[index].isAvailable = !newRooms[index].isAvailable;
                            setRooms(newRooms);
                          }}
                        />
